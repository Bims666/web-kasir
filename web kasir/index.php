...
<?php
// jika tidak memakai username dan password di database (alias manual) alternatif bimo :)
/*
...
// jika tidak memakai md5 password alternatif bimo :)
/*
if(isset($_POST['proses_login'])) {
...
//jika memakai md5 password alternatif bimo :)
